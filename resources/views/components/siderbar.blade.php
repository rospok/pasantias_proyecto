<aside
  ...
  class="header-sidebar sidebar fixed left-0 top-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 dark:border-gray-800 dark:bg-black lg:static lg:translate-x-0"
>
  <!-- SIDEBAR HEADER -->
  <div
  ...
  >
    <a href="index.html">
      <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
        <div class="div-logo">
        <img class="dark:hidden logo-icon" src="{{ asset('tailadmin/images/logo-desarrolo.png') }}" alt="Logo"/>
        <img
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            ...
            >
              ...
              <span
                class="menu-item-text sidebar-span"
                :class="sidebarToggle ? 'lg:hidden' : ''"
              >
                Calendar
              </span>
